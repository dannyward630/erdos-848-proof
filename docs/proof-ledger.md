...
| CD0 | The tracked primary checker provides one fresh uninterrupted authenticated replay of every all-\(N\) computational stage and negative control | Six-stage receipt `222c5313...a71009`; all stage/log/output hashes; terminal theorem-grade PASS after 8,487.79 seconds; independently reconstructed receipt chain in `certificates/all-n-root-replay-2026-08-11.md` | IP-FIN, IP-LOWER, IP-LOW, IP-MIDDLE, H-SOTH, C0 |
...
|---|---|---|---|
| P848 | The source-faithful conjecture is completion-certified under every requirement in `AGENTS.md` | M0, VM0, CD0, LROOT, L1, L2, RCLEAN, V0 | Mathematical proof and fresh root computational replay are complete; the clean ART-006 build, trust-zero/live-axiom/dependency audit, clean-checkout reproduction, and combined final review remain |
